            ...
            <div id="carouselExampleInterval" class="carousel slide carousel-container" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="2500">
                        <img src="<?= base_url('assets/images/Adopciones.jpg'); ?>" class="d-block w-100" alt="Adopciones">
                    ...
                    <div class="carousel-item" data-bs-interval="2500">
                        <img src="<?= base_url('assets/images/Adoptador.jpg'); ?>" class="d-block w-100" alt="Adoptador">
                        <div class="carousel-caption d-none d-md-block">
                            <h2>Adopciones</h2>
                            <p>Mira las adopciones registradas hasta el momento 👌</p>
                        </div>
